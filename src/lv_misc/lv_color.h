                                                                 ...
                                                                 lv_color_t * res_color, lv_opa_t * res_opa)
{
    ...
    /*Both colors have alpha. Expensive calculation need to be applied*/
        ...
        static lv_color_t fg_color_save;
        static lv_color_t bg_color_save;
        static lv_color_t res_color_saved;
...
#define LV_COLOR_MAKE(r8, g8, b8)                                                                                      \
    ((lv_color_t){{(uint8_t)((b8 >> 6) & 0x3U), (uint8_t)((g8 >> 5) & 0x7U), (uint8_t)((r8 >> 5) & 0x7U)}})
#elif LV_COLOR_DEPTH == 16
#if LV_COLOR_16_SWAP == 0
...
#else
#define LV_COLOR_MAKE(r8, g8, b8)                                                                                      \
    ((lv_color_t){{(uint16_t)((g8 >> 5) & 0x7U), (uint16_t)((r8 >> 3) & 0x1FU), (uint16_t)((b8 >> 3) & 0x1FU),         \
                   (uint16_t)((g8 >> 2) & 0x7U)}})
#endif
#elif LV_COLOR_DEPTH == 32
